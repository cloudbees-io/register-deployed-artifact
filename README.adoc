...
[IMPORTANT]
====
The action version cloudbees-io/register-deployed-artifact@v1 is deprecated and is no longer supported. Please update your workflows to use link:https://github.com/cloudbees-io/register-deployed-artifact/tree/v2[cloudbees-io/register-deployed-artifact@v2].
