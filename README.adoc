...
This registration saves the artifact information to the CloudBees Unify.
...
This example publishes an image with xref:build-tools:kaniko.adoc[Kaniko], and then reports the data to the CloudBees Unify.
...
* Learn about link:https://docs.cloudbees.com/docs/cloudbees-platform/latest/[the CloudBees Unify].
